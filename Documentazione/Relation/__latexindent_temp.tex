...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/mockups/signInSignUp.png}\\
	\caption{Login and Sign Up pages}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/mockups/loginSocial.png}\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{images/mockups/search.png}\\
	\caption{scrivere}
\end{figure}
