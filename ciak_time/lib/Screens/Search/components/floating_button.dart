          ...
          Row(
            children: [
              FilterChip(
                ...
                shape: StadiumBorder(
                    side: BorderSide(
                        color: kPrimaryColor, width: size.width * 0.0055)),
          ...
          Row(
            ...
            children: [
              FilterChip(
                ...
                onSelected: (bool value) {
                  setState(() {
                    selected_most_recent = !selected_most_recent;
                    selected_rate = false;
                    selected_most_added = false;
                ...
                Row(
                  ...
                  children: [
                    ...
                    FilterChip(
                      ...
                      labelStyle: TextStyle(color: colorFantasy),
                    ...
                    FilterChip(
                      ...
                      labelStyle: TextStyle(color: colorThriller),
          ...
          Row(
            ...
            children: [
              ...
              OutApplyButtonFilter(
                size: size,
                selectedTerm: widget.widget.selectedTerm,
              ),
            ],
          ),
        ],
