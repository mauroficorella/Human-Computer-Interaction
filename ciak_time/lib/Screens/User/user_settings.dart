...
import 'package:ciak_time/components/change_password_field_confirm.dart';
...
class IsMatchValidator extends TextFieldValidator {
  ...
  // pass the error text to the super constructor
  IsMatchValidator(
      {String errorText = 'Insert a valid username', @required this.string})
      : super(errorText);
...
class _UserSettingsState extends State<UserSettings> {
                                            ...
                                            children: [
                                              TextFieldContainer(
                                                child: TextFormField(
                                                  ...
                                                  validator:
                                                      getValidator(userlogged),
                                                  /*(value) {
                                                    if (value == '') {
                                                      return MatchValidator(
                                                              errorText:
                                                                  'Insert a non empty username')
                                                          .validateMatch(
                                                        usermodified,
                                                        value,
                                                      );
                                                        ...
                                                        usermodified) {
                                                      return UnMatchValidator(usermodified);
                                                    }
                                                  },*/
                                                  autovalidateMode:
  ...
  TextFieldValidator getValidator(value) {
    if (value == '') {
      return IsMatchValidator(string: value);
    } else if (value == usermodified) {
      return UnMatchValidator(string: usermodified);
    }
  }
}
